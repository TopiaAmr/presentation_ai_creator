        ...
        "slides": [
            {
                ...
                "title": "أهمية الأخلاق في العمل والحياة",
                "subtitle": "قيمنا الأخلاقية وأثرها",
            },
            {
                "layout_type": "title_content",
                "title": "المقدمة",
                "content": [
                    "أثر سرعة وضغط الحياة على قيمنا الأخلاقية.",
                    "الأخلاق والسمعة كأساس للنجاح.",
                ],
            },
            {
                "layout_type": "title_content",
                ...
                "content": [
                    "**الأخلاق والنجاح المستدام:**",
                    "  التعامل بأخلاق وأصول لتحقيق النجاح الصحي.",
                    "**منظور أوسع للأعمال:**",
                    "  الأعمال ليست حربًا، بل فرصة للتعاون والنمو المتبادل.",
                    "**التفكير الجماعي:**",
                    "  أهمية سؤال الآخرين والاستفادة من خبراتهم.",
                    "**الاستفادة من ذوي الخبرة:**",
                    "  كيف ساعدت آراء الخبراء في تشكيل رؤيتي.",
                    "**القيم والمبادئ:**",
                    "  التركيز على المبادئ الصحيحة والأصول في كل ما نقوم به.",
                    "**السمعة الطيبة:**",
                    "  بناء سمعة قوية كأصل لا يقدر بثمن.",
                    "**النزاهة:**",
                    "  النزاهة والشفافية في التعاملات.",
                    "**العدالة:**",
                    "  العدل والمساواة في فرص العمل.",
                    "**المسؤولية:**",
                    "  تحمل المسؤولية عن أفعالنا وقراراتنا.",
                ],
            },
            {
                "layout_type": "title_content",
                "title": "الخلاصة",
                "content": [
                    "دعوة لإعادة تقييم أولوياتنا ووضع الأخلاق في المقدمة.",
                    "الأخلاق كبوصلة توجهنا نحو النجاح الحقيقي والمستدام.",
                ],
            },
        ]
    }
